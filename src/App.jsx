...
function App() {
  ...
  return (
    ...
    <div id='homepage'>
      ...
      <img height="600px" id="homepage-image" src="../src/assets/homepage.png"></img>
    ...
    <div id="about">
      ...
      <div id="about-image">
        <img src='../src/assets/blackbg.png' height="600px"></img>
      </div>
    ...
    <div>
      ...
      <div id="know-more">
        <div>
        <img src='../src/assets/green-white.png' height="500px"></img>
      </div>
    ...
    <div id="features-container">
      <div>
        <img src='../src/assets/abstract.png' height="500px"></img>
      </div>
    ...
    <div>
      ...
      <img  src="../src/assets/blue.png" height="120px" width="500px" id="pic"></img>
